...
#define STRING_CONFIG_H_AUTHOR "(DIGIBRO3D, 09.04.2021)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SkeletonX v2.0"
...
#define TEMP_BED_RESIDENCY_TIME     45  // (seconds) Time to wait for bed to "settle" in M190
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  52.43
    #define DEFAULT_Ki  10.48
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
 ...
 // #define DEFAULT_bedKd 305.4
  #define DEFAULT_bedKp 20.63
  #define DEFAULT_bedKi .21
  #define DEFAULT_bedKd 1320.09
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 80, 3200, 144 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 700, 700, 25, 50 } // 1500, 1500 bylo ok
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 30, 60, -1 }
