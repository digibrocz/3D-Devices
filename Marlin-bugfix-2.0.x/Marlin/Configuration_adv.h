...
#define DUAL_X_CARRIAGE
  ...
  #define X1_MAX_POS X_BED_SIZE-60  // Set a maximum so the first X-carriage can't hit the parked second X-carriage
...
#define Z_STEPPER_AUTO_ALIGN
 ...
 // #define Z_STEPPER_ALIGN_XY { {  80, 80 }, { 250,  420 }, { 420, 80 } }  
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  0.03      // (steps or mm) Steps or millimeter distance for each Z babystep
