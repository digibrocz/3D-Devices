...
#define Y_DUAL_STEPPER_DRIVERS
  ...
  #define INVERT_Y2_VS_Y_DIR true   // Set 'true' if Y motors should rotate in opposite directions // u skeletona true
...
#define DUAL_X_CARRIAGE
  ...
  #define X1_MAX_POS 520  //(X_BED_SIZE) Set a maximum so the first X-carriage can't hit the parked second X-carriage
  #define X2_MIN_POS    0       // Set a minmum to ensure the  second X-carriage can't hit the parked first X-carriage
  #define X2_MAX_POS   576       // Set this to the distance between toolheads when both heads are homed
  ...
  #define DEFAULT_DUPLICATION_X_OFFSET 240
#endif
...
#define Z_STEPPER_AUTO_ALIGN
  ...
  #define Z_STEPPER_ALIGN_KNOWN_STEPPER_POSITIONS
    ...
    #define Z_STEPPER_ALIGN_STEPPER_XY { { -50, -140 }, { 50, -140 }, { 250, 640 } }
  #else
...
//#define CUSTOM_USER_MENUS
  ...
  #define CUSTOM_USER_MENU_TITLE "DIGIBRO3D"
