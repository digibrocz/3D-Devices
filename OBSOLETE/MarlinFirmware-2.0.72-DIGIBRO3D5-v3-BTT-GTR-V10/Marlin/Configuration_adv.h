...
#define DUAL_X_CARRIAGE
  ...
  #define X1_MAX_POS X_BED_SIZE-50  // Set a maximum so the first X-carriage can't hit the parked second X-carriage
...
#define Z_STEPPER_AUTO_ALIGN
  ...
  #define Z_STEPPER_ALIGN_XY { {  50, 50 }, { 250,  450 }, { 450, 50 } }
  ...
  #define Z_STEPPER_ALIGN_KNOWN_STEPPER_POSITIONS
    ...
    #define Z_STEPPER_ALIGN_STEPPER_XY { { 0, 0 }, { 500, 500 }, { 250, 500 } }
  #else
 ...
 */
  ...
  #define Y_HYBRID_THRESHOLD     300  // na 300 nedelalo bordel na 100 obcas "skrtne" ale otazka jestli je to tim
  ...
  //#define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    //#define Y_STALL_SENSITIVITY  3 //-10 bylo ok
